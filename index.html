...
<head>
	<meta charset="UTF-8">
	<title>Front Utah Conference - UX &amp; PM</title>
...
<body>
	...
	<main class="home">
		...
		<section class="spotlight">
			<ul>
				<li>
					...
					<p class="date-location">Salt Lake City, 9-10 May 2017</p>
		...
		<section class="about">
			...
			<p>Front is the product conference for UX designers and product managers. It's a practitioner’s conference. Attendees come for an education, real world, from-the-trenches case studies, and hands-on training from their peers. It's four total days of learning and growth, providing answers to deep organizational questions and insights into how to validate and solve the right problems in the right way.</p>
		</section>
		<section class="personal-stories">
			<h2>Personal stories from innovative teams</h2>
			<ul class="story-cards">
				<li>
					<div href="https://vimeo.com/167029277" class="card-image recap-video"><img src="images/front-speaker-sian-townsend.jpg" alt=""></div>
					<h3>Sian Townsend</h3>
					<p>Jobs to be Done: from Doubter to Believer</p>
				</li>
				<li>
					<div href="https://vimeo.com/167025212" class="card-image recap-video"><img src="images/front-speaker-sam-vanessa.jpg" alt=""></div>
					<h3>Sam Goertler &amp; Vanessa Koch</h3>
					<p>Last things first: A redesign strategy that&hellip;</p>
				</li>
				<li>
					<div href="https://vimeo.com/167736107" class="card-image recap-video"><img src="images/front-speaker-tracey-varnell.jpg" alt=""></div>
					<h3>Tracey Varnell</h3>
					<p>Collaborative techniques for product leaders</p>
				</li>
				<li>
					<div href="https://vimeo.com/166885565" class="card-image recap-video"><img src="images/front-speaker-bob-baxley.jpg" alt=""></div>
					<h3>Bob Baxley</h3>
					<p>Designing the machine that designs the designs</p>
				</li>
				<li>
					<div href="https://vimeo.com/167004431" class="card-image recap-video"><img src="images/front-speaker-keenan-cummings.jpg" alt=""></div>
					<h3>Keenan Cummings</h3>
					<p>Product vision and storytelling</p>
				</li>
				<li>
					<div href="https://vimeo.com/167006595" class="card-image recap-video"><img src="images/front-speaker-kyle-jacobsen.jpg" alt=""></div>
					<h3>Kyle Jacobson</h3>
