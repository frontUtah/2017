...
$trainings[] = array(
	...
	'summary' => "Showing our work at all different levels is a core part of design within an organization. Running a critique with your team that’s effective and helpful for everyone isn’t an easy task when it comes to pushing everyone to be better but also being respectful. With high growth teams, escalated career growth, responsibilities, and maintaining clear communication of work being done are just some of the challenges that design teams are facing. Design critiques provide a platform for designers to socialize work with others in a way that encourages productive feedback, healthy discourse, and a mindful surfacing of alternative approaches to any given design problem.",
	'description' => "Showing our work at all different levels is a core part of design within an organization. Running a critique with your team that’s effective and helpful for everyone isn’t an easy task when it comes to pushing everyone to be better but also being respectful. With high growth teams, escalated career growth, responsibilities, and maintaining clear communication of work being done are just some of the challenges that design teams are facing. <br><br>Design critiques provide a platform for designers to socialize work with others in a way that encourages productive feedback, healthy discourse, and a mindful surfacing of alternative approaches to any given design problem. <br><br>What most teams struggle with around design critiques/reviews:<ul><li>Having an effective solution for socializing work across teams and the organization</li><li>Having healthy discourse around the best design solutions</li><li>Having a productive feedback mechanism to improve work</li><li>Having an avenue for mindful surfacing of alternative approaches to any given design problem</li></ul>I'll share ways that you can improve these processes and make these gatherings enjoyable and exciting again.",
	'price' => '7,000',
	'capacity' => '10-50',
	'length' => '1 day'
);
...
$trainings[] = array(
	...
	'summary' => "Balancing the needs of the users, business, team and yourself is certainly a challenge. As designers we’re naturally wired to defend and create for the needs of the user. Business…wants to stay in business, and Development…wants to build amazing forward thinking technology while not drowning in its own debt. Lets talk about how we can build amazing products without coming to a stalemate with every conversation.",
...
$trainings[] = array(
	...
	'summary' => "What do OKRs, Roadmaps, and Resource Planning have in common? They're all necessary, but mostly hated, practices in modern product teams. In this workshop, we'll learn how to use these tools together to create compelling plans for your team that garner support and resources from executives without sacrificing your team's agile autonomy.",
...
$trainings[] = array(
	...
	'subjects' => array('leadership', 'product-management'),
...
$trainings[] = array(
	...
	'summary' => "Have you ever been told that you need to be more strategic, or that you need to work on your executive presence? What does that even mean? These skills can be elusive for early-career PMs, but they're totally learnable. In this workshop, we'll break down what it takes to be good at these things, and even get some hands-on practice developing them.",
