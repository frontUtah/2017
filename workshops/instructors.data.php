...
$instructors[] = array(
	...
	'bio' => 'Vicky is the VP Product at Clockwise, where she leads the product management and product design teams to help the world make time for what matters. Prior to Clockwise, Vicky built products and product teams at Adobe, Lucid Software, Vivint Smart Home, and Rivet. Vicky’s decade of product leadership experience spans consumer software to enterprise SaaS, smart home mobile apps to healthcare IT, and Series A to public companies. She is a passionate advocate for STEM education and inclusivity in tech, and is a longtime volunteer for FIRST robotics and her alma mater, MIT. When she’s not working or volunteering, Vicky can be found flying small airplanes or adventuring in Utah’s great outdoors.',
	'twitter' => '__vickyt',
	'instagram' => '',
...
// Sophia Prater
 ...
 $instructors[] = array(
 	...
 	'bio' => "David is a product designer, angel investor and writer focused on building products, companies, and teams. He is currently Head of Product Design at Webflow and previously led design at One Medical, Black Pixel, and founded his own product consultancy. He has an affinity for design/developer tools, two-sided marketplaces, and software that is impactful for consumers and enterprise. His areas of focus are generative research, prototyping, building scaling design teams, and new initiatives.<br /><br />In his free time, David angel invests and advises for early stage startups. He taught User Experience at General Assembly and previously guest lecutred at institutions including The Copenhagen Institute of Interaction Design, The University of Washington, Duke University, and Hyper Island. He currently resides in California.",
 	'twitter' => 'davidhoang',
 	'instagram' => '',
