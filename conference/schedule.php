...
$title = 'Schedule - Front UX & Product Management Case Study Conference and Workshop Series, 10-13 November 2020';
		...
		<div class="course-calendar">
				...
				<ul class="days-courses">
					...
					<li class="course">
						<dl>
							...
							<dd class="instructor"></dd>
							<dd class="description">
								<!-- <h4><a href="/conference/workshops">Workshops</a></h4> -->
								<h4>Workshops</h4>
							</dd>
						</dl>
					</li>
					<li class="course">
						<dl>
							<dt class="time">12:30<span class="am-pm">PM</span></dt>
							<dd class="instructor"></dd>
							<dd class="description">
								<h4>Hot lunch</h4>
							</dd>
					...
					<li class="course">
						<dl>
							<dt class="time">1:30<span class="am-pm">PM</span></dt>
							<dd class="instructor"></dd>
							<dd class="description">
								<!-- <h4><a href="/conference/workshops">Workshops</a></h4> -->
								<h4>Workshops</h4>
			...
			<div class="course-date">
				...
				<ul class="days-courses">
					...
					<li class="course">
						<dl>
							<dt class="time">6:00<span class="am-pm">PM</span></dt>
							<dd class="instructor"></dd>
							<dd class="description">
								<h4>Early registration for conference-only attendees</h4>
							</dd>
						</dl>
					</li>
					<li class="course">
