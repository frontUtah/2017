...
$title = 'Venue - Front UX & Product Management Case Study Conference, 15-17 September 2021';
...
?>
	<main class="secondary venue venue-conference">
		...
		<section class="sports">
			...
			<p><strong>Calvin L. Rampton Salt Palace Convention Center</strong><br />100 S. West Temple<br />Salt Lake City, Utah 84101</a></p>
		</section>
		...
		<section class="sports">
			...
			<div class="webcam">
			<p>The Calvin L. Rampton Salt Palace Convention Center is in the heart of downtown Salt Lake City. With many comfortable hotels, award winning restaurants, and unique evening activities this location is perfect to experience the city the way that it was meant to be.</p>
		</section>
		<section class="photo-collage">
